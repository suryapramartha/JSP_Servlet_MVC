...
<div class="container">
	...
	<form action="ProjectController" method="POST">
		<table border="1" width="75%" >
			...
			<tr>
				<td>End Date</td>
				<td><input type="date" id="projectEndForm" name="endDateForm"  value="<%=end_date%>" min="<%=dat %>" class="form-control"></input></td>
			</tr>
			<tr>
				<td>Status</td>
	...
	<input type="button" class="btn btn-primary" value="Cancel" onclick="window.location='ProjectController';"></input> 
